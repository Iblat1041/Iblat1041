...
**Python Backend Developer.** В разработке с 2022 года, коммерческий опыт — с 2025. Проектирую и разрабатываю backend-сервисы, REST API и системы автоматизации. Развиваюсь в направлении архитектуры, DDD, высоконагруженных и распределённых систем.
...
### **[UbiProxy — сервис защищённого прокси-доступа](https://ubiproxi.ru)**
  Сервис [ubiproxi.ru](https://ubiproxi.ru) для регистрации пользователей, управления подписками и выдачи персональных ссылок подключения для Hiddify. Реализованы административная панель, управление устройствами и мониторинг прокси-узлов.

  **Обязанности:** 
  - спроектировал архитектуру сервиса;
  - разработал backend;
  - реализовал регистрацию и подтверждение email;
